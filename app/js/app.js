...
app.controller('mainController', ['$scope', function($scope){
	...
	$scope.languages = [{
		...
		exp: '50%',
		color: '#4caf50',
		text: "<h2 class='heading multiColor tileHeader'>[[Speak Brackets] toMe];</h2><h5>Go to Frameworks</h5><ul><li><a class='multiColor' href='https://github.com/Mantle/Mantle'>Mantle</a></li><li><a class='multiColor' href='https://github.com/ReactiveCocoa/ReactiveCocoa'>ReactiveCocoa</a></li></ul><p> first and foremost, Objective-C is my first passion. I learned it before I learned any other programming language. I had no idea it was one of the most <a href='https://youtu.be/73uu9YTq_1M'>difficult languages to learn</a>. I use this as motivation when I come across obstacles. Now with swift making its way in, programming for Apple devices has never been easier. </p>"
	}, {
		name:'HTML/CSS',
		exp: '85%',
		color: '#2196f3',
